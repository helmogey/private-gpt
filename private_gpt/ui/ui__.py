...
class PrivateGptUi:
        ...
        with gr.Blocks(
            ...
            with gr.Row():
                gr.HTML(
                    ...
                    <div class="logo-container">
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR_bS9Z-_0BLzFCzTEys0CJPF48FS5K61yp2Q&s" alt="NEC Logo">
                        <h1>NEC GPT</h1>
                    </div>
                    """
                )
            ...
            theme_toggle_btn.click(
                ...
                function() {
                    ...
                    // If the __theme param is not set, we can assume it's in dark mode
    ...
    def mount_in_app(self, app: FastAPI, path: str) -> None:
        ...
        # Get UI username and password directly from environment variables
        # These are the UI_USERNAME and UI_PASSWORD you just set in your .env file
        auth_user = os.getenv("UI_USERNAME")
        auth_pass = os.getenv("UI_PASSWORD")

        # Create the auth tuple only if both variables are set
        ...
        gr.mount_gradio_app(
            ...
            blocks,
            path=path,
            auth=auth_credentials,  # Use the credentials from .env
